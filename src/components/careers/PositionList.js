...
function PositionList(){
    return(
        <div className="max-w-full mx-auto lg:mx-12 bg-white">
            ...
            <p className="text-2xl font-regular text-gray-900 max-w-5xl leading-10">Lets write some beautiful code and make smart designs, This is what we are crazy about, and we are looking for the ones wo feel the same</p>
