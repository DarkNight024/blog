...
function Navbar() {
    ...
    return (
        <nav id='navbar' className='w-full py-6 top-0 transition duration ease-in-out z-40 fixed'>
            <div className="px-4 sm:px-6">
                ...
                <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <div className="ml-4 mt-2 flex-shrink-0">
                        ...
                        >
                            Hire Us
                            <DotLoader className="ml-3 -mr-1 h-5 w-5" aria-hidden="true" loading={loading} color="#f2f2f2" margin={5} size={20} speedMultiplier={0.5}/>
                        </Link>
                    </div>
                </div>
