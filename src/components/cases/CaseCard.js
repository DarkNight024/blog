...
function CaseCard({data, index}){
    return(
        ...
        className="flex flex-col hover overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="flex flex-1 flex-col justify-between bg-white p-6">
          <div className="flex-1">
            ...
            <a href={data.href} className="mt-2 block">
              <p id={index=data.title} className="lg:text-4xl pt-4 pb-6 text-2xl font-semibold transition duration-400 text-gray-900">{data.title}</p>
